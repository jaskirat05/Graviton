...
supported_workflow_extensions: set[str] = {'.flow', '.json'}
...
folder_names_and_paths["templates"] = ([os.path.join(models_dir, "templates")], supported_workflow_extensions)

output_directory = os.path.join(base_path, "output")
temp_directory = os.path.join(base_path, "temp")
input_directory = os.path.join(base_path, "input")
user_directory = os.path.join(base_path, "user")
templates_directory = os.path.join(models_dir, "templates")
